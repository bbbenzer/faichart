...
session_start();
$Chk=0;
if (isset($_SESSION['chk'])) $Chk = $_SESSION['chk'];
...
<div <span style="font-size:50px">รายงานสรุป ฝ้ายเบเกอรี่</span></div>
  ...
  <tbody>
    <tr>
      ...
      <td>
      	<button  hidden="hidden" class="button" style="vertical-align:middle" onClick="c01(6)">
      		<span style="cursor:pointer">
            <? if($Chk==6){ ?><img src="images/check01.png" id="im02" width="25px" height="25px"> <? } ?>
            6.กราฟ เปรียบเทียบ % ของเสีย <?= date("Y")+543 ?>/<?= (date("Y")+543)-1 ?></span>
        </button> 
