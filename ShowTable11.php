...
<?php
	...
	function xSaleTotalALL($cus_code,$osDate,$oeDate,$nsDate,$neDate,$df){
		$xVal1 = 0;
		$Sql1 = "SELECT 
				(SELECT SUM(income_to_day.SumTotal) 
				FROM income_to_day 
	...
	function xSaleLose($cus_code,$osDate,$oeDate,$nsDate,$neDate,$df){
		$xVal1 = 0;
		$Sql1 = "SELECT 
	...
	function xSaleLoseALL($cus_code,$osDate,$oeDate,$nsDate,$neDate,$df){
		$xVal1 = 0;
		$Sql1 = "SELECT 
				(SELECT SUM(income_to_day.Lost) 
				FROM income_to_day 
...
echo "<TABLE border='0'>";
echo "<TR>";
echo "<TD width='600px' valign='top'>";
	echo "<TABLE border='1'>";
	echo "<TR>";
	...
	for($j=0;$j<$i;$j++){
		echo "<TD width='200px' align='center' class='fb'>".
		number_format(xSaleLose($xCode[$j],$aoDate,$goeDate,$anDate,$gneDate,1)/xSaleTotal($xCode[$j],$aoDate,$goeDate,$anDate,$gneDate,1)*100, 2, '.', ',')
		."%</TD>";
	}
	echo "</TR>";
...
echo "<TD width='600px' valign='top'>";
	...
	for($j=0;$j<$i;$j++){
		echo "<TD width='200px' align='center' class='fb'>".
		xSaleTotalALL($xCode[$j],$gosDateAll,$goeDate,$gnsDateAll,$gneDate,1).
		"</TD>";
	}
	echo "</TR>";
	...
	for($j=0;$j<$i;$j++){
		echo "<TD width='200px' align='center' class='fb'>".
		number_format( xSaleLoseALL($xCode[$j],$gosDateAll,$goeDate,$gnsDateAll,$gneDate,1)/xSaleTotalALL($xCode[$j],$gosDateAll,$goeDate,$gnsDateAll,$gneDate,1)*100, 2, '.', ',')
