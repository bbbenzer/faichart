...
$result = mysql_query( "UPDATE chart_menu SET Chk = 3" );
...
<html>
	...
	<script type="text/javascript">
					...
					function getSomething(){
							$.getJSON('getGraph03.php', function(data) {
								  var total = [];
								  $.each(data, function(key, val) {
										total.push({name:val.name,y:parseFloat(val.y),drilldown:val.drilldown});
								  });
					...
					// Create the chart
								...
								//alert(  );
									  Highcharts.chart('container', {
												...
												title: {
													text: 'เปรียบเทียบของเสียรวมทุกสาขา ประจำเดือน '+mthai															                                                },
												subtitle: {
													text: ''
												},
												xAxis: {
